...
/* The following declarations are copied verbatim from SpiceZpr.h from the CSPICE toolkit version N0064.  To use an updated version of the toolkit
these declarations will need to be updated as well.

NB: The declaration for gfuds_c causes ffi-swig-generator 0.3.2 to crash with "undefined method `/' for nil:NilClass" 
Thus, you must be sure to remove the declaration of this function if you re-copy the decls from SpiceZpr.h
...
/* this method for some reason causes ffi-swig-generator to crash */
/*
